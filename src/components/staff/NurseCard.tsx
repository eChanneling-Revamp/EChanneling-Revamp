...
export default function NurseCard({ nurse, onEdit, onDelete }: NurseCardProps) {
  ...
  const config =
    statusConfig[nurse.status as keyof typeof statusConfig] ||
    statusConfig.Active;
  ...
  return (
    <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl border border-gray-200 hover:border-purple-300 transition-all duration-300 overflow-hidden">
      {/* Header with gradient */}
      <div className="h-20 bg-gradient-to-br from-purple-500 via-purple-600 to-pink-600 relative">
        <div className="absolute -bottom-10 left-6">
          <div className="h-20 w-20 rounded-2xl flex items-center justify-center text-white shadow-lg ring-4 ring-white bg-gradient-to-br from-purple-700 to-pink-700">
        ...
        <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            ...
            className="p-2 bg-white/90 backdrop-blur-sm rounded-lg hover:bg-white shadow-md text-purple-600 hover:text-purple-700 transition-all"
          >
      ...
      <div className="pt-14 px-6 pb-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-2">
            <FiBriefcase className="w-4 h-4 text-purple-600 flex-shrink-0" />
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="flex items-start gap-3 group/item">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-900 truncate">{nurse.email}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 group/item">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-900 truncate">{nurse.phone}</p>
            </div>
          </div>
          ...
          {/* Experience */}
          <div className="flex items-start gap-3 group/item">
            <div className="mt-0.5 p-2 bg-orange-50 rounded-lg group-hover/item:bg-orange-100 transition-colors">
              <FiBriefcase className="w-3.5 h-3.5 text-orange-600" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs text-gray-500 font-medium mb-0.5">
                Experience
